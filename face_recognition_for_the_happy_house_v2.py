...
Original file is located at
    https://colab.research.google.com/drive/1CD8Ofkwp32a4-j10hsRSyvh9bwP85S8w
...
# Check the input shape of the FRmodel
input_shape = FRmodel.input_shape
print(f"Target size: {input_shape[1]}x{input_shape[2]}, Channels: {input_shape[3]}")
...
database["sabeel"] = img_to_encoding("images/sabeel.jpg", FRmodel)
...
verify("images/sabeel.jpg", "sabeel", database, FRmodel)
...
output = who_is_it("images/sabeel.jpg", database, FRmodel)
